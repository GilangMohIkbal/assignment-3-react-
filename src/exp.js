let experience = [
  {
    ...
    category: "Project 1",
    name: "Class Room",
    about: "Membuat website yang menyerupai Google Class Room",
    detail:
    ...
    tools: ["Node Js", "ExpressJs", "MySQL", "VueJS", "NuxtJS"],
    link: "",
  ...
  },
  {
    ...
    detail:
      "Pembuatan website Uji Coba untuk mahasiswa PPG UNJ dalam menghadapi Ujian Kompetensi yang diselenggrakan oleh Kemendikbud",
    fitur:
    ...
    peran: "Front-end",
    tools: ["VueJS", "NuxtJS", "Boostrap 5"],
    link: "https://simppg.unj.ac.id/ukmppg",
    status: "selesai",
  },
  {
    id: 4,
    ...
    link: "https://6563416025e1946aa7f4981f--jovial-beijinho-346ac2.netlify.app/course/chapter/1-chapter-1/lesson/1-introduction-to-typescript-with-vue-js-3",
